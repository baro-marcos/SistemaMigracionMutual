...
import com.mutual.SistemaMigracionMutual.Servicios.CobroMigracionService;

public class MigracionTblCobro {
	
	CobroMigracionService migracionService = new CobroMigracionService();
	...
	public boolean ejecutarProcesoMigracion() {
		...
		try {
            ...
            String archivoDBF = propiedades.getProperty("archivo.COBROS.dbf");
			...
			while ((row = reader.nextRow()) != null) {
				...
				objeto.setCondona(row.getString("CONDONA"));
