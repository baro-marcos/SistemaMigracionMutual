...
@Entity
@Table(name = "COBROS_CUOTAS_AYUDAS_FRANCES")
public class CobroCuotaAyudaFrances {
	
	@Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Autoincremental
	@Column(name = "ID_COBRO_CUOTA_AYUDA_FRANCES")
    private Long idCobroCuotaAyudaFrances;
	...
	public CobroCuotaAyudaFrances() {
		
	}

	public CobroCuotaAyudaFrances(Long idCobroCuotaAyudaFrances, Integer numeroAyuda, Integer numeroCuota,
			BigDecimal montoCuota, BigDecimal cer, Date fechaPagoCuota, BigDecimal cargos, BigDecimal descuento,
		...
		super();
		this.idCobroCuotaAyudaFrances = idCobroCuotaAyudaFrances;
	...
	public Long getIdCobroCuotaAyudaFrances() {
		return idCobroCuotaAyudaFrances;
	}

	public void setIdCobroCuotaAyudaFrances(Long idCobroCuotaAyudaFrances) {
		this.idCobroCuotaAyudaFrances = idCobroCuotaAyudaFrances;
	}
