...
@Entity
@Table(name = "AYUDAS_FRANCES")
public class AyudaFrances {
	
	@Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Autoincremental
	@Column(name = "ID_AYUDA_FRANCES")
    private Long idAyudaFrances;
	...
	private Integer mesesGracia;					// GRACIA
	
	@Column(name = "TS_MESES_GRACIA")
	private BigDecimal tsMesesGracia;				//TSGRACIA
	...
	public AyudaFrances(Long idAyudaFrances, Integer nroAyuda, Integer numeroSocio, Date fechaAltaAyuda,
			...
			Integer mesesGracia, BigDecimal tsMesesGracia, String seguro) {
		super();
		this.idAyudaFrances = idAyudaFrances;
		...
		this.tsMesesGracia = tsMesesGracia;
		this.seguro = seguro;
	}

	public Long getIdAyudaFrances() {
		return idAyudaFrances;
	}

	public void setIdAyudaFrances(Long idAyudaFrances) {
		this.idAyudaFrances = idAyudaFrances;
	}
	...
	public BigDecimal getTsMesesGracia() {
		return tsMesesGracia;
	}

	public void setTsMesesGracia(BigDecimal tsMesesGracia) {
		this.tsMesesGracia = tsMesesGracia;
	}
